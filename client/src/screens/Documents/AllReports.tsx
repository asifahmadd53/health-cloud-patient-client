...
export default function AllReports({ route }) {
    ...
    const renderEmptyState = () => (
        <View className="flex-1 items-center justify-center py-20">
            <Text className="text-gray-400 text-base">No reports found</Text>
            <Text className="text-gray-400 text-sm mt-2">Upload your first report to get started</Text>
        </View>
    );
        ...
        <SafeAreaView className="flex-1 bg-white">
            ...
            <View className="flex-1 px-5 pt-4">
                <View className="flex-row justify-between items-center mb-4">
                    <Text className="text-lg font-bold">My Reports</Text>
