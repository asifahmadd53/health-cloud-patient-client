...
const DoctorCard = () => {
    ...
    return (
        <TouchableOpacity activeOpacity={0.9} onPress={() => navigation.navigate("DrProfileRoutes")}>
            <View className="flex-row items-center bg-white border border-slate-200 shadow-md rounded-2xl px-4 py-3 mb-4 shadow-slate-200">
                ...
                <View className="flex-1 ml-4">
                    ...
                    <Text className="text-sm font-medium text-gray-600 lg:text-lg">MBBS, Dermatologist Specialist</Text>

                    {/* Rating & Location Section */}
                    <View className="flex-row justify-between items-end ">
                        <Text className="text-sm font-medium text-green-700 lg:text-lg mt-1">Fee: $50 per session</Text>

                        <View className="flex-row items-center gap-1">
                            <Image className="w-5 lg:w-8 h-5 lg:h-8 opacity-80" source={Icons.location} />
